    ...
    <FormContainer>
      ...
      <Form onSubmit={submitHandler}>
        ...
        <Form.Group controlId='countInStock'>
          ...
          <Form.Control type='Number' placeholder='Enter Num of Items' value={countInStock} onChange={(e)=>setCountInStock(e.target.value)}></Form.Control>
        </Form.Group>
        <Form.Group controlId='description'>
          <Form.Label>Description</Form.Label>
          <Form.Control type='text' placeholder='Enter Desciption for product' value={description} onChange={(e)=>setDescription(e.target.value)}></Form.Control>
        </Form.Group>
